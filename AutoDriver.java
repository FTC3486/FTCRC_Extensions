...
public class AutoDriver {
    ...
    public void driveForwardtoEncoderCountWithCorrection(int encoderCount, double power, int gyroTarget) {
    ...
    public void driveBackwardtoEncoderCountWithCorrection(int encoderCount, double power, int gyroTarget) {
        driveTrain.resetMotorEncoders();
